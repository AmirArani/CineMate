...
import '../movies/favorite_movies.dart';
import '../shows/favorite_shows.dart';
                    ...
                    children: [
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            context.read<FavoritesBloc>().add(const SelectMovieTabEvent(0));
                          },
                          child: Container(
                      ...
                      Expanded(
                        child: GestureDetector(
                          onTap: () {
                            context.read<FavoritesBloc>().add(const SelectMovieTabEvent(1));
                          },
                          child: Container(
                            decoration: BoxDecoration(
